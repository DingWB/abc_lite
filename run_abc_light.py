...
def main():
    ...
    parser.add_argument('--juicebox_path', type=str, default='java -jar /data/earmand/projects/dp_hic_revision/abc_model/juicer/juicer_tools_1.22.01.jar')
    ...
    hic_command = ( f'python {args.src_path}/juicebox_dump.py '
     ...
     f'--outdir {args.out}/hic_dump --juicebox "{args.juicebox_path}"'
    )
    print('hic command: \n', hic_command)
